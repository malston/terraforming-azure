...
resource "azurerm_subnet_network_security_group_association" "pas_subnet_network_security_group_association" {
...
resource "azurerm_subnet_network_security_group_association" "services_subnet_network_security_group_association" {
...
resource "azurerm_subnet_network_security_group_association" "dynamic_services_subnet_network_security_group_association" {
